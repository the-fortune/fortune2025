...
label g_222222:
    $ g_exp_messages = """
        ...
        사업 확장이나 신규 사업에 착수하는 것은 좋지 않으므로 당분간 내실을 꾀하면서 관망하는 것이 좋다.{/size}
        """
...
label g_212111:
    ...
    $ g_exp_messages = """
        ...
        {size=60}위는 물(水)이고 아래는 하늘(天)이다. 수(需)는 ‘기다리다’ ‘기대하다’라는 뜻이다.
        운무가 자욱한 상이다.
...
label g_222212:
    ...
    $ g_exp_messages = """
        ...
        {size=60}위는 땅(地)이고 아래는 물(水)이다. 사(師)는 ‘선생’ ‘군대’라는 뜻이다.
...
label g_212222:
    $ g_exp_messages = """
        ...
        {size=60}위는 물(水)이고 아래는 땅(地)이다. 비(比)는 ‘견주다’ ‘비교하다’ ‘인화(人和)’를 상징한다.
...
label g_112111:
    $ g_exp_messages = """
        ...
        {size=60}위는 바람(風)이고 아래는 하늘(天)이다. 축(畜)은 ‘기르다’ ‘저축하다’라는 뜻이다.
...
label g_111211:
    $ g_exp_messages = """
        ...
        {size=60}위는 하늘(天)이고 아래는 못(澤)이다. 이(履)는 ‘밟는다’ ‘따른다’ ‘예절’이라는 뜻이다.
...
label g_222111:
    $ g_exp_messages = """
        ...
        {size=60}위는 땅(地)이고 아래는 하늘(天)이다. 태(泰)는 ‘크다’ ‘크게 통한다’ ‘태평하다’라는 뜻이다.
        ...
        운세는 매우 순조롭고 이익도 크다. 방심하지만 않으면 크게 성공한다.{/size}
        """
...
label g_111222:
    $ g_exp_messages = """
        ...
        {size=60}위는 하늘(天)이고 아래는 땅(地)이다. 비(否)는 ‘막히다’ ‘답답하다’라는 뜻이다.
...
label g_121111:
    $ g_exp_messages = """
        ...
        {size=60}위는 불(火)이고 아래는 하늘(天)이다. 대유(大有)는 크게 만족하여 즐거워하는 상태를 말한다.
...
label g_221222:
    $ g_exp_messages = """
        ...
        {size=60}위는 우뢰 천둥(雷)이고 아래는 땅(地)이다. 예(豫)는 ‘예측한다’라는 뜻이다.
...
label g_122112:
    $ g_exp_messages = """
        ...
        사업은 부정부패와 무능이 만연된 상태이므로 구태의연한 모든 것을 혁신해야하며 세대교체를 해야 만이 살아남는다.{/size}
        """
...
label g_222211:
    $ g_exp_messages = """
        ...
        그러나 뜻하지 않은 변화가 속출하기 때문에 철저한 준비와 주변 사람들과 긴밀한 유대관계가 중요하다.{/size}
    """
...
label g_112222:
    $ g_exp_messages = """
        ...
        {size=60}위는 바람(風)이고 아래는 땅(地)이다. 관(觀)은 ‘살핀다’라는 뜻이다.
...
label g_121221:
    $ g_exp_messages = """
        ...
        {size=60}위는 불(火)이고 아래는 천둥 우레(雷)다. 서합(噬嗑)에서 서(噬)는 씹다라는 뜻이고,
        ...
        사업은 처음에는 어려움이 많겠지만,
        나중에는 크게 성공할 수 있으므로 새로운 사업을 벌이거나 사업 규모를 확장해도 좋다.{/size}
    """
...
label g_122121:
    $ g_exp_messages = """
        ...
        {size=60}위는 산(山)이고 아래는 불(火)이다. 비(賁)는 ‘꾸미다’ ‘장식하다’라는 뜻이다.
...
label g_122222:
    $ g_exp_messages = """
        ...
        {size=60}위는 산(山)이고 아래는 땅(地)이다. 박(剝)은 ‘벗기다’ ‘빼앗다’라는 뜻이다.
        ...
        내부에서 분규가 일어나 어려움을 겪을 수 있으며 동업자나 신임하던 부하에게 배신당할 염려가 있다.{/size}
    """
...
label g_222221:
    $ g_exp_messages = """
        ...
        {size=60}위는 땅(地)이고 아래는 우레 천둥(雷)이다. 복(復)은 ‘돌아오다’ ‘회복하다’라는 뜻이다.
        ...
        사업은 새로운 사업을 계획하는 것보다는 한번 실패했던 일을 다시 하거나 전에 하던 일을 하면 더욱 좋다.{/size}
    """
...
label g_111221:
    $ g_exp_messages = """
        ...
        사업은 애를 써도 이루어지지 않으니 현상유지를 하면서 순리대로 일을 처리해야 한다.{/size}
    """
...
label g_122111:
    $ g_exp_messages = """
        ...
        {size=60}위는 산(山)이고 아래는 하늘(天)이다. 대축(大畜)은 ‘크게 쌓다’ ‘많이 모이다’라는 뜻이다.
        ...
        대축(大畜)에는 ‘머물다’ ‘기다리다’의 뜻도 있어 큰일을 이루기 위해서 준비한다는 의미도 되기 때문이다.{/size}
    """
...
label g_122221:
    $ g_exp_messages = """
        ...
        {size=60}위는 산(山)이고 아래는 천둥 우레(雷)다. 이(頤)는 ‘턱’ ‘기르다’ ‘봉양하다’의 뜻이다.
...
label g_211112:
    $ g_exp_messages = """
        ...
        내실을 기하여 현상유지에 힘써야 한다. 매우 불길한 괘이므로 대형사고 등에 조심해야 한다.{/size}
    """
...
label g_212212:
    $ g_exp_messages = """
        ...
        {size=60}위도 물(水)이고 아래도 물(水)이다. 물이 겹쳐 있으니 수(水)를 괘 이름으로 하였다.
...
label g_211122:
    $ g_exp_messages = """
        ...
        {size=60}위는 못(澤)이고 아래는 산(山)이다. 함(咸)은 감(感)과 같은 뜻으로 ‘느낌이 좋다’는 의미다.
...
label g_221112:
    $ g_exp_messages = """
        ...
        {size=60}위는 천둥 우레(雷)이고 아래는 바람(風)이다. 항(恒)은 ‘변함이 없다’ ‘한결 같이 계속 된다’라는 뜻이다.
...
label g_111122:
    $ g_exp_messages = """
        ...
        {size=60}위는 하늘(天)이고 아래는 산(山)이다. 둔(遯)은 ‘피하다’ ‘물러나다’ ‘은둔하다’라는 뜻이다.
        ...
        안될 일이라면 용단을 내려 미련 없이 손을 떼는 것이 오히려 이익일 수 있다.{/size}
    """
...
label g_221111:
    $ g_exp_messages = """
        ...
        {size=60}위는 천둥 우레(雷)이고 아래는 하늘(天)이다. 대장(大壯)을 ‘힘차다’ ‘성대하다’ ‘씩씩하다’라는 뜻이다.
...
label g_121222:
    $ g_exp_messages = """
        ...
        {size=60}위는 불(火)이고 아래는 땅(地)이다. 진(晋)은 ‘나아가다’ 전진하다‘라는 뜻이다.
...
label g_112121:
    $ g_exp_messages = """
        ...
        {size=60}위는 바람(風)이고 아래는 불(火)이다. 가인(家人)은 ‘집을 지키는 사람’을 뜻한다.
...
label g_121211:
    $ g_exp_messages = """
        ...
        {size=60}위는 불(火)이고 아래는 못(澤)이다. 규(睽)는 ‘서로 등지다’ ‘노려보다’ ‘사팔눈’이라는 뜻이다.
...
label g_212122:
    $ g_exp_messages = """
        ...
        {size=60}위는 물(水)이고 아래는 산(山)이다. 건(蹇)은 ‘절뚝발이’ ‘나아가기 힘들다’ ‘멈추다’라는 뜻이다.
...
label g_221212:
    $ g_exp_messages = """
        ...
        {size=60}위는 천둥 우레(雷)이고 아래는 물(水)이다. 해(解)는 ‘해결되다’ ‘해소된다’ ‘풀린다’라는 뜻이다.
...
label g_122211:
    $ g_exp_messages = """
        ...
        {size=60}위는 산(山)이고 아래는 못(澤)이다. 손(損)은 ‘덜다’ ‘줄이다’ ‘손해보다’라는 뜻이다.
...
label g_112221:
    $ g_exp_messages = """
        ...
        사업은 무리만 하지 않는다면 모든 일이 순조롭게 진행되어 성공할 수 있다.{/size}
    """
...
label g_211111:
    $ g_exp_messages = """
        ...
        {size=60}위는 못(澤)이고 아래는 하늘(天)이다. 쾌(夬)는 ‘물리친다’ ‘결단한다’는 뜻이다.
...
label g_211222:
    $ g_exp_messages = """
        ...
        {size=60}위는 못(澤)이고 아래는 땅(地)이다. 췌(萃)을 ‘모인다’라는 뜻이다.
...
label g_222112:
    $ g_exp_messages = """
        ...
        {size=60}위는 땅(地)이고 아래는 바람(風)이다. 승(升)을 ‘위로 상승하다’ ‘올라가다’ ‘번성하다’라는 뜻이다.
        ...
        너무 서두르지 않고 충분하게 내실을 다지면서 전진해 가면 반드시 성공한다.{/size}
    """
...
label g_211212:
    $ g_exp_messages = """
        ...
        {size=60}위는 못(澤)이고 아래는 물(水)이다. 곤(困)을 ‘부족하다’ ‘곤궁하다’ ‘괴롭다’ ‘통하지 않는다’라는 뜻이다.
...
label g_212112:
    $ g_exp_messages = """
        ...
        {size=60}위는 물(水)이고 아래는 바람(風)이다. 정(井)을 ‘우물’ ‘두레박’을 뜻한다.
        ...
        큰 욕심을 버려야 하고 남에게 베풀어야 한다. 물이 고여 있으면 섞기 때문이다.{/size}
    """
...
label g_211121:
    $ g_exp_messages = """
        ...
        {size=60}위는 못(澤)이고 아래는 불(火)이다. 혁(革)을 ‘바꾸다’ ‘혁신하다’ ‘혁명’의 뜻이다.
...
label g_121112:
    $ g_exp_messages = """
        ...
        {size=60}위는 불(火)이고 아래는 바람(風)이다. 정(鼎)을 ‘발이 셋인 솥’ ‘안정감’을 뜻한다.
        ...
        주변 사람들과 일치 협력하여 일을 하면 크게 성공한다. 그러나 화합이 안되면 크게 실패한다.{/size}
    """
...
label g_122122:
    $ g_exp_messages = """
        ...
        {size=60}위도 산(山)이고 아래도 산(山)이다. 산이 첩첩이 있으니 산(山)을 괘 이름으로 하였다.
        ...
        산 넘어 산이니 분수를 모르고 경거망동하면 안되고 산처럼 묵묵하게 꾸준히 노력하면 곧 그 산을 넘게 된다.{/size}
    """
...
label g_112122:
    $ g_exp_messages = """
        ...
        {size=60}위는 바람(風)이고 아래는 산(山)이다. 점(漸)은 ‘점점’ ‘점차로 나아지는 것’을 뜻한다.
...
label g_221211:
    $ g_exp_messages = """
        ...
        {size=60}위는 천둥 우레(雷)이고 아래는 못(澤)이다. 귀매(歸妹)는 ‘정상적이지 못한 결혼’이라는 뜻이다.
        ...
        현상유지를 하는 것이 최선이므로 새로운 일이나 확장은 금물이다.{/size}
    """
...
label g_221121:
    $ g_exp_messages = """
        ...
        {size=60}위는 천둥 우레(雷)이고 아래는 불(火)이다. 풍(豊)은 ‘풍성하다’라는 뜻이다.
        ...
        앞으로 다가올 혹독한 불황을 견디려면 불필요한 인원과 지출을 줄이고 저축을 해놓아야 한다.{/size}
    """
...
label g_121122:
    $ g_exp_messages = """
        ...
        사업은 나아가기보다는 물러설 때다. 신규 사업에 손을 대거나 확장은 위험하다.{/size}
    """
...
label g_211211:
    $ g_exp_messages = """
        ...
        {size=60}위도 못(澤)이고 아래도 못(澤)이다. 태(兌)을 ‘즐거움’ ‘온화한 분위기’를 뜻한다.
        ...
        사업은 적극적으로 밀고 나갈 때가 아니므로 전진보다는 내실을 기하는 것이 좋다.{/size}
    """
...
label g_112212:
    $ g_exp_messages = """
        ...
        {size=60}위는 바람(風)이고 아래는 물(水)이다. 환(渙)을 ‘흩어지다’ ‘풀어지다’라는 뜻이다.
...
label g_212211:
    $ g_exp_messages = """
        ...
        {size=60}위는 물(水)이고 아래는 못(澤)이다. 절(節)을 ‘절도’ ‘규칙이나 제한’ ‘절약’을 뜻한다.
...
label g_112211:
    $ g_exp_messages = """
        ...
        역량에 맞지 않는 일은 하지 말고 혼자보다는 주위의 도움을 받으면 더욱 좋다.{/size}
    """
...
label g_212121:
    $ g_exp_messages = """
        ...
        사업은 현재는 좋은 상황이나 서서히 쇠퇴해가므로 내실을 기하고 규모를 줄여 다가올 불황에 대비해야 한다.{/size}
    """
