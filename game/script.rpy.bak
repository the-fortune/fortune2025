...
screen my_start_button():
    # 배경 이미지 추가
    add "images/EmptyBg.jpg"  # 배경 이미지 파일
...
label assemble_ramdom_bricks:
    ...
    show text "{size=60}{color=#330994}괘를 구했습니다.{/color}{/size}" with irisout
...
transform slow_fade_out:
    alpha 1.0  # 초기 투명도
    linear 10.0 alpha 0.0  # 3초 동안 투명도를 0으로 변경
