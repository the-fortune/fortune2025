...
# 아내가 만들어준 이미지 사이즈에 맞춰서..
define config.screen_width = 1440
define config.screen_height = 2560

init python:
    # config.nvl_window_height = 2500
    # config.nvl_window_width = 1440
    style.nvl_window = Style(style.window)
    style.nvl_window.xmaximum = 1400
    style.nvl_window.ymaximum = 2500
    style.nvl_window.xalign = 0.0
    style.nvl_window.yalign = 0.0
...
define config.save_directory = "WoonMyung-1739794174"
